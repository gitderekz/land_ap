...
class _UploadPopupDealsState extends State<UploadPopupDeals> {
  ...
  Future<String> hifadhiDeals(var context) async {
    String name = nameController.text;
    String bio = bioController.text;
    String bei = beiController.text;
    String message = await Deals().saveData(name: name, bio: bio, bei: bei, nchi: nchi, mkoa: mkoa, wilaya: wilaya, matumizi: matumizi, file: _image!, userFirstName: widget.userFirstName, userLastName: widget.userLastName, userPhone: widget.userPhone, userId: widget.userId, context: context);
    return message;
  }
