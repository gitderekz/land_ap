...
class _UploadPopupState extends State<UploadPopup> {
  ...
  void saveProfile() async{
    ...
    String message = await StoreData().saveData(name: name, bei: bei, bio: bio, nchi: nchi, mkoa: mkoa, wilaya: wilaya, matumizi: matumizi, file: _image!,userFirstName: widget.userFirstName,userLastName: widget.userLastName,userPhone: widget.userPhone,userId: widget.userId);
  }
