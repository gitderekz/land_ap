...
class QuickDealReadMore extends StatefulWidget {
  ...
  const QuickDealReadMore({Key? key, required this.hospitalImagePath, required this.hospitalName, required this.hospitalLocation, required this.hospitalDescription, required this.hospitalSnapshot, required this.hospitalId, required this.userFirstName, required this.userLastName, required this.userGender, required this.userPhone, required this.userId, required this.receptionPhone, required this.userAddress}) : super(key: key);

  @override
  State<QuickDealReadMore> createState() => _QuickDealReadMoreState();
}

class _QuickDealReadMoreState extends State<QuickDealReadMore> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => showModalBottomSheet(shape: RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(25.0))), context: context, builder: (context) => QuickDealReadMore()),
      child: Text(
