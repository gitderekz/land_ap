            ...
            children: [
              ...
              TabBar(
                // indicator: ,
                  ...
                  tabs: [
                    Tab(text: 'Request Medical Report',icon: Icon(Icons.note_alt,color: Colors.green,),),
                    Tab(text: 'View Medical Report',icon: Icon(Icons.note_alt_outlined,color: Colors.green[300],),)
                  ]
              ),
              SizedBox(height: 8.0,),
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: (){
                                  ...
                                  FirebaseFirestore.instance.collection('hospitals').doc(widget.hospitalId).collection('reports')
                                          ...
                                          children: [
                                            ...
                                            ElevatedButton.icon(
                                                ...
                                                onPressed: (){
                                                  openReport(
                                                      'open',
                                                      '${reportLinkList[index]}',
                                                      '${reportNameList[index].toString().replaceAll('\nmedical report', '')}-medical-report(${hospitalIdList[index]} ${dateList[index]}).pdf'
                                                  );
                                                },
                                                icon: Icon(Icons.check_circle), label: Text('Open')
                                            )
                                                :
                                            ElevatedButton.icon(
                                                style: TextButton.styleFrom(
