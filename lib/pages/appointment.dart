...
class _AppointmentState extends State<Appointment> {
  ...
  void _showDatePicker() {
    showDatePicker(context: context, initialDate: DateTime.now(), firstDate: DateTime(2022), lastDate: DateTime(2050)).then((value) {
      setState(() {
        datePicker = value!;
                              ...
                              InkWell(
                                onTap: () {
                                  ...
                                  if (chosenClinic != '-Choose Clinic' && chosenDoctor != '-Choose Doctor' && chosenSession != '-Choose Session' && firstNameController.text.isNotEmpty && lastNameController.text.isNotEmpty && phoneController.text.isNotEmpty && hospitalController.text.isNotEmpty && genderController.text.isNotEmpty) {
                                    FirebaseFirestore.instance.collection('hospitals').doc(widget.hospitalId).collection('appointments').doc('${widget.userId},$dateAndTime').set({
                                      'answer': false,
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            // Text('${dateList[index]}\n${timeList[index]}',),
                                            Text(
                                              '${appointmentTimeList[index].replaceAll(' ', '\n')}\n${timeList[index]}',
                                            ),
                                            Text(
