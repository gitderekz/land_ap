  ...
  Future<Polyline> drawPolyline(LatLng from, LatLng to) async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
        ...
        optimizeWaypoints:true
          ...
          polylineCoordinates.add(LatLng(from.latitude, from.longitude));
    ...
    // });
    print("array size = ${polylineCoordinates.length}");
    print("point1 = ${polylineCoordinates[0].latitude} ${polylineCoordinates[0].longitude}");
    print("point2 = ${polylineCoordinates[1].latitude} ${polylineCoordinates[1].longitude}");
